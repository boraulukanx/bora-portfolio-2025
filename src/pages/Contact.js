...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    ...
    // Backend olmadığı için frontend'de simüle ediyoruz
    setTimeout(() => {
      setLoading(false);
      setSubmitted(true);
      setForm({
      ...
      // 5 saniye sonra submitted durumunu sıfırlıyoruz
      setTimeout(() => {
        setSubmitted(false);
      }, 5000);
    }, 1500);
          ...
          <div className="w-full bg-tertiary p-8 rounded-2xl">
            ...
            <div className="flex flex-col gap-4">
              <div className="flex items-center gap-3">
                ...
                <p className="text-white-100">your.email@example.com</p>
              </div>
              <div className="flex items-center gap-3">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
              ...
              <div className="flex items-center gap-3">
                ...
                <p className="text-white-100">New York, NY, USA</p>
              </div>
            </div>
